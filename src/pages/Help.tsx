  ...
  const helpCategories = [
    {
      ...
      items: [
        ...
        { label: 'Como rastrear minha encomenda', to: '/help/rastrear' },
      ]
    },
    {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-sm text-gray-500 mt-2 max-w-xl mx-auto">
            Encontre respostas para suas dúvidas e saiba como aproveitar ao máximo o HSE Marketplace
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8 mb-12">
          ...
          <div className="space-y-4">
            {[
              ...
              { q: 'Como posso rastrear meu pedido?', a: 'Após a confirmação do pagamento, você receberá um código de rastreio por email. Também pode acompanhar na seção "Meus Pedidos".' },
              { q: 'O produto não atendeu minhas expectativas. E agora?', a: 'Você tem até 7 dias após o recebimento para solicitar a devolução. Entre em contato com nosso suporte.' },
              { q: 'Como me torno um vendedor?', a: 'Acesse a página "Vender no HSE" e preencha o formulário de cadastro de empresa. Nossa equipe entrará em contato.' },
            ].map((faq, index) => (
        ...
        <div className="bg-gradient-to-r from-orange-500 to-amber-500 rounded-2xl p-6 sm:p-8 text-white text-center">
          ...
          <p className="text-orange-100 mb-6">Nossa equipe está pronta para ajudar você</p>
          <Link
            to="/contact"
